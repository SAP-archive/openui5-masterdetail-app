...
sap.ui.define([
	...
	function(Log, fLibrary, Core, jQuery) {
		"use strict";
		...
		var SAP_ILLUSTRATION_POOL_ID = 'sap-ui-illustration-pool',
			...
			SAP_ILLUSTRATION_SET_PATH = sap.ui.require.toUrl("sap/f/themes/base/illustrations/"),
			SAP_ILLUSTRATION_SET_SYMBOLS = Object.keys(fLibrary.IllustratedMessageType);
		 ...
		 * {@link sap.f.IllustrationPool.registerIllustrationSet registerIllustrationSet} API of <code>IllustrationPool</code>.
		 ...
		 * when it's needed by using the {@link sap.f.IllustrationPool.loadAsset} API.
