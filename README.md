...
> [OpenUI5](https://github.com/SAP/openui5) masterdetail app using the [UI5 Build and Development Tooling](https://github.com/SAP/ui5-tooling).
...
1. Clone the repository (on the `ui5-tooling` branch) and navigate into it
    ```sh
    git clone -b ui5-tooling https://github.com/SAP/openui5-masterdetail-app.git
